...
export const REFERENCE_SCHEMA: Record<EntityType, RefDeclaration[]> = {
  game: [
    {
      ...
      cardinality: "many",
      required: true,
      on_delete: "remove_ref_or_stale_if_empty",
    },
    {
      field: "formalizations",
      target: "formalization",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
    {
      field: "coupling_links",
      target: "cross_game_link",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
  ...
  formalization: [
    ...
    {
      field: "outside_options.*.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "outside_options.*.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "commitment_power.*.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "commitment_power.*.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.delta.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.delta.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.beta.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "discount_factors.*.beta.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
  ...
  player: [
    {
      field: "risk_profile.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "risk_profile.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "reservation_utility.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "reservation_utility.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "audience_costs.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "audience_costs.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
  ...
  game_node: [
    ...
    {
      field: "terminal_payoffs.*.source_claims",
      target: "claim",
      cardinality: "many",
      required: true,
      on_delete: "remove_ref_or_stale_if_empty",
    ...
    {
      field: "terminal_payoffs.*.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "terminal_payoffs.*.latent_factors",
      target: "latent_factor",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
  ...
  game_edge: [
    ...
    {
      field: "triggers_cross_game_links",
      target: "cross_game_link",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "choice_forecast.conditions.*.ref_id",
      target: ["assumption", "scenario", "game_edge"],
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
    {
      field: "choice_forecast.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "choice_forecast.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "chance_estimate.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "chance_estimate.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "payoff_delta.*.source_claims",
      target: "claim",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "payoff_delta.*.assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "payoff_delta.*.latent_factors",
      target: "latent_factor",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
  ...
  derivation: [
    {
      field: "from_ref",
      target: ["source", "observation", "claim", "inference", "assumption"],
      cardinality: "one",
      required: true,
      on_delete: "cascade_delete",
    },
    {
      field: "to_ref",
      target: ["claim", "inference", "assumption", "game_node", "game_edge"],
      cardinality: "one",
      required: true,
      on_delete: "cascade_delete",
    },
  ...
  latent_factor: [
    {
      field: "affects",
      target: ["assumption", "game_node", "game_edge"],
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
  ...
  cross_game_link: [
    ...
    {
      field: "target_ref",
      target: ["formalization", "game_node", "player"],
      cardinality: "one",
      required: true,
      on_delete: "cascade_delete",
    },
    {
      field: "conditions.*.ref_id",
      target: ["assumption", "scenario", "game_edge"],
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
  ...
  scenario: [
    ...
    // path and invalidators are descriptive text arrays, not entity references
    {
      field: "key_assumptions",
      target: "assumption",
      cardinality: "many",
      required: false,
      on_delete: "mark_stale",
    },
    {
      field: "key_latent_factors",
      target: "latent_factor",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "central_thesis_ref",
      target: "central_thesis",
      cardinality: "one",
      required: false,
      on_delete: "remove_ref",
    },
    {
      field: "model_basis",
      target: ["game", "formalization"],
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
    {
      field: "cross_game_interactions",
      target: "cross_game_link",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
  ...
  escalation_ladder: [
    ...
    {
      field: "rungs.*.player_attribution",
      target: "player",
      cardinality: "one",
      required: false,
      on_delete: "remove_ref",
    ...
    {
      field: "rungs.*.evidence_refs",
      target: ["source", "observation", "claim", "inference"],
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
  ...
  trust_assessment: [
    ...
    {
      field: "driving_patterns",
      target: "repeated_game_pattern",
      cardinality: "many",
      required: false,
      on_delete: "remove_ref",
    },
...
function hasMatchingStaleCause(entity: unknown, target: EntityRef): boolean {
  const markers = (entity as { stale_markers?: ReadonlyArray<StaleMarker> })
    .stale_markers;
...
export function validateStoreInvariants(
    ...
    for (const reference of collectDeclaredReferences(
      ...
      if (!(target.id in targetRecord)) {
        if (
          ...
          hasMatchingStaleCause(entity, target)
        ) {
          continue;
        }
  ...
  for (const node of Object.values(store.nodes)) {
    ...
    const outgoing = Object.values(store.edges).filter(
    ...
    if (hasMissingChanceEstimate || Math.abs(total - 1) > 0.001) {
      errors.push(
        `Outgoing chance estimates for node ${node.id} must sum to 1.0 ± 0.001.`,
      );
    }
  }
  ...
  for (const formalization of Object.values(store.formalizations)) {
    ...
    for (const informationSet of formalization.information_sets) {
      const edgeCounts = informationSet.node_ids.map(
        (nodeId) =>
          Object.values(store.edges).filter((edge) => edge.from === nodeId)
            .length,
      );
