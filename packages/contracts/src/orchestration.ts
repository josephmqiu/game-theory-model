...
const AnalysisPhase = Schema.Literals([
...
const AnalysisEntitySource = Schema.Literals(["ai", "human", "computed"]);

const AnalysisEntityConfidence = Schema.Literals(["high", "medium", "low"]);

const AnalysisEntityId = TrimmedNonEmptyString;
const AnalysisRelationshipId = TrimmedNonEmptyString;

const AnalysisLoopbackTriggerType = Schema.Literals([
  "revalidation",
  "human-edit",
  "confidence-drop",
  "cross-game-conflict",
...
export const AnalysisLoopbackRecordedPayload = Schema.Struct({
  runId: AnalysisRunId,
  triggerType: AnalysisLoopbackTriggerType,
...
const EventBaseFields = {
  ...
  aggregateId: Schema.Union([ProjectId, ThreadId, AnalysisRunId]),
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.started"),
    payload: AnalysisStartedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.phase.began"),
    payload: AnalysisPhaseBeganPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.entity.created"),
    payload: AnalysisEntityCreatedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.entity.updated"),
    payload: AnalysisEntityUpdatedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.entity.deleted"),
    payload: AnalysisEntityDeletedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.relationship.created"),
    payload: AnalysisRelationshipCreatedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.phase.completed"),
    payload: AnalysisPhaseCompletedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.loopback.recorded"),
    payload: AnalysisLoopbackRecordedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.rolled-back"),
    payload: AnalysisRolledBackPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.aborted"),
    payload: AnalysisAbortedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("analysis.completed"),
