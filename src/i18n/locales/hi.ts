...
const hi: TranslationKeys = {
  ...
  // ── Top Bar ──
  "topbar.hideLayers": "रूपरेखा छिपाएँ",
  "topbar.showLayers": "रूपरेखा दिखाएँ",
  "topbar.new": "नया",
  "topbar.open": "खोलें",
  "topbar.save": "सहेजें",
  ...
  "topbar.complete": "पूर्ण",
  "topbar.incomplete": "{{count}} सेल शेष",
  "topbar.issues": "{{count}} समस्या(एँ)",
  ...
  // ── Right Panel ──
  "rightPanel.design": "विवरण",
  "rightPanel.code": "कोड",
  "rightPanel.noSelection": "एक आइटम चुनें",
  ...
  // ── Layers ──
  "layers.title": "रूपरेखा",
  "layers.empty":
    "अभी कोई आइटम नहीं है। निर्माण शुरू करने के लिए टूलबार का उपयोग करें।",
  ...
  "textLayout.autoWidthDesc":
    "ऑटो चौड़ाई \u2014 टेक्स्ट क्षैतिज रूप से फैलता है",
  ...
  "ai.tryExample": "एक वर्कस्पेस प्रॉम्प्ट आज़माएँ...",
  "ai.tipSelectElements":
    "सुझाव: संदर्भ के लिए चैट करने से पहले वर्कस्पेस में आइटम चुनें।",
  "ai.generating": "जनरेट हो रहा है...",
  "ai.designWithAgent": "इस वर्कस्पेस के बारे में एजेंट से पूछें...",
  ...
  "ai.quickAction.loginScreen": "इस वर्कस्पेस का सारांश दें",
  "ai.quickAction.loginScreenPrompt":
    "वर्तमान वर्कस्पेस और डॉक्यूमेंट संदर्भ में दिखाई देने वाले मुख्य आइटम का सारांश दें।",
  "ai.quickAction.foodApp": "चयन का वर्णन करें",
  "ai.quickAction.foodAppPrompt":
    "वर्तमान में चयनित आइटम और किसी भी महत्वपूर्ण संरचना का वर्णन करें जो आप देखते हैं।",
  "ai.quickAction.bottomNav": "अगले कदम सुझाएँ",
  "ai.quickAction.bottomNavPrompt":
    "वर्तमान वर्कस्पेस के आधार पर, तीन ठोस अगले कदम सुझाएँ।",
  "ai.quickAction.colorPalette": "उपलब्ध एजेंट समझाएँ",
  "ai.quickAction.colorPalettePrompt":
    "बताएँ कि अभी कौन से कनेक्टेड एजेंट और MCP टूल उपलब्ध हैं और वे इस वर्कस्पेस में कैसे मदद कर सकते हैं।",
