const en = {
  ...
  "agents.customProvider": "Custom API",
  "agents.customProviderDesc": "Any OpenAI-compatible endpoint — OpenCode Go/Zen, OpenRouter, DeepSeek, or your own URL",
  "agents.customPreset": "Provider preset",
  "agents.customBaseUrl": "Base URL",
  "agents.customApiKey": "API key",
  "agents.customModelIds": "Model IDs (comma-separated, optional)",
  "agents.customNativeSearch": "Model has built-in web search",
  "agents.customNativeSearchHint": "When on, the app's web search tool is not offered to this endpoint",
  "agents.customModels": "Custom models",
  "agents.searchProvider": "Search provider",
