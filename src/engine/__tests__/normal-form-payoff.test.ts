...
describe('update_normal_form_payoff command', () => {
  ...
  it('updates a payoff cell for a given player and cell index', () => {
    ...
    expect(formalization.payoff_cells[0]?.payoffs.player_1).toMatchObject(samplePayoff)
  })
  ...
  it('does not mutate the original store', () => {
    ...
    expect(originalFormalization.payoff_cells[0]?.payoffs.player_1).toEqual(originalPayoff)
    expect(updatedFormalization.payoff_cells[0]?.payoffs.player_1).toMatchObject(samplePayoff)
  })
