...
const VIEW_LABELS: Record<ViewType, string> = {
  ...
  phase_1: 'P1 Grounding',
  phase_2: 'P2 Players',
  phase_3: 'P3 Baseline',
  phase_4: 'P4 History',
  phase_5: 'P5 Revalidation',
  phase_6: 'P6 Formalization',
  phase_7: 'P7 Assumptions',
  phase_8: 'P8 Elimination',
  phase_9: 'P9 Scenarios',
  phase_10: 'P10 Meta-check',
  settings: 'Settings',
  // Legacy views
