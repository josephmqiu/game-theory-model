...
import { executePhaseTurn } from "./analysis-phase-turn-service";
import {
    ...
    try {
      ...
      const result = await executePhaseTurn(
        ...
        writeContext,
        {
          ...
          activePhases: phases,
          completedPhases,
          progressCompletedBefore: phasesCompleted,
          progressTotal: phases.length,
          phaseTurnCounts,
      ...
      latestPhaseTurnId = result.phaseTurnId;
