  ...
  return {
    ...
    upsertPhaseTurnSummary(phaseTurn) {
      upsertStatement.run({
        ...
        $promptPackId: phaseTurn.promptProvenance.promptPackId,
        $promptPackVersion: phaseTurn.promptProvenance.promptPackVersion,
        $promptPackMode: phaseTurn.promptProvenance.promptPackMode,
