// This file mostly exists because we want dev mode to say "Game Theory Analyzer (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Game Theory Analyzer (Dev)" : "Game Theory Analyzer (Alpha)";
const APP_BUNDLE_ID = "com.gta.game-theory-analyzer";
