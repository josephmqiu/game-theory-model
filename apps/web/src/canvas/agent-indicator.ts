...
const INDICATORS_KEY = "__gta_agent_indicators__";
const PREVIEWS_KEY = "__gta_agent_previews__";
const AGENT_FRAMES_KEY = "__gta_agent_frames__";
...
export function addAgentIndicator(
  nodeId: string,
  color: string,
  name: string,
): void {
